...
public class LinearViewHolder extends RecyclerView.ViewHolder{
    ...
    public LinearViewHolder(View v){
        ...
        subContentTV = (TextView) v.findViewById(R.id.tv_item_linear_sub);
        rateTV = (TextView) v.findViewById(R.id.tv_item_linear_rate);
        maxRateTV = (TextView) v.findViewById(R.id.tv_item_linear_max_rate);
    }
}
